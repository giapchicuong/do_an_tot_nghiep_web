...
export default function DropdownAvatar({ title, data, handleClick, valueSelected, name, full, center, email, roleName }) {
                ...
                >
                    ...
                    >
                        <div className="flex flex-col gap-1">
                            ...
                            <p className='text-sm font-semibold text-textColor'>{email ?? ''}</p>
                            <p className='text-xs font-semibold text-textColor opacity-60'>{roleName ?? ''}</p>
                        </div>
