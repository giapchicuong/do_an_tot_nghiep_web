        ...
        <table class="table-auto w-full h-full text-textColor">
            <thead className='bg-inputPlaceholder'>
                <tr>
                    ...
                    <th className='p-5 text-base font-bold text-start whitespace-nowrap'>Tên nhóm</th>
                    ...
                    data && data.map((item, index) =>
                        <tr key={index}>

                            {
                                ...
                                <td className='p-5 text-base font-normal text-start whitespace-nowrap'>{item.groupId}</td>
                            }
                            {
                                item.groupName &&

                                <td className='p-5 text-base font-normal text-start whitespace-nowrap'>{item.groupName}</td>
                            }
                            {
                                item.createdAt &&
